...
# PostgreSQL + pgvector (전용 EC2 dontdelay-DB — 설치·SG: docs/DATABASE_EC2.md)
SPRING_DATASOURCE_URL=jdbc:postgresql://<DB_PRIVATE_IP>:5432/dontdelay
SPRING_DATASOURCE_USERNAME=dontdelay_app
